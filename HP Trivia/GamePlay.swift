...
struct GamePlay: View {
            ...
            ZStack {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        .animation(.easeOut(duration: animateViewsIn ? 1.4 : 0).delay(animateViewsIn ? 2 : 0), value: animateViewsIn)
    ...
    private func playMusic() {
        let songs = ["let-the-mystery-unfold", "hiding-place-in-the-forest", "deep-in-the-dell", "spellcraft"]
